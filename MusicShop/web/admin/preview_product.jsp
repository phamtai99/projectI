...
<html>
    <head>
        ...
        <title>BK ACOUSTIC SHOP - THÔNG TIN ĐƠN PHẨM</title>
...
<body>
    ...
    <%
        ...
        Product product = (Product) session.getAttribute("previewProduct");
    ...
    <jsp:include page="header.jsp"></jsp:include>
        <div class="banner-top">
            <div class="container">
                ...
                <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="#">Trang Chủ</a><label>/</label>Đơn Phẩm</h3>
            ...
            <div class="container">
                <div class="col-md-3 product-bottom ">
                    ...
                    <div class="categories animated wow fadeInUp animated" data-wow-delay=".5s" >
                        ...
                        %>
                        <li><i class="glyphicon glyphicon-menu-right" ></i><a href="#"><%=c.getCategoryName()%></a></li>	
                                <% } %>
                    </ul>
                    ...
                    <div class="product-head">
                        ...
                        <div class="product-go">
                            <div class=" fashion-grid">
                                <a href="#>"><img class="img-responsive " src="<%=p.getProductImageForward()%>" alt=""></a>

                            </div>
                            <div class=" fashion-grid1">
                                <h6 class="best2"><a href="#"><%=p.getProductName()%></a></h6>
                    ...
                    <div class="span_2_of_a1 simpleCart_shelfItem">
                        ...
                        <div class="price_single">
                            ...
                            <form method="post" action="/MusicShop/InsertProductServletx" enctype="multipart/form-data">
                                <input name="maloai" value="<%=product.getCategoryID()%>"></input>
                                <button type="submit" data-text="Thêm vào giỏ" class="but-hover1 item_add">Thêm vào giỏ</button>
                            </form>
                            <div class="clearfix"> </div>
                        </div>
                            ...
                            <div class="resp-tabs-container">
                                ...
                                <h2 class="resp-accordion" role="tab" aria-controls="tab_item-2"><span class="resp-arrow"></span>Reviews</h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
                                    <div class="comments-top-top">
                                        <%
                                            for (Review r : reviewGet.getListReviewByProduct(productID)) {
                                        %>
                                        ...
                                        <a class="add-re" href="#"><i class="glyphicon glyphicon-comment" ></i> Viết Đánh Giá</a>
                                    </div>
        ...
        $(document).ready(function () {
            ...
            <div class=" col-md-si">
                <%
                    for (Product p : productGet.getListProductRelated(category_id, productID)) {
                %>
