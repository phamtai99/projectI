...
<head>
	...
	<title>SẢN PHẨM - BK ACOUSTIC SHOP</title>
	<meta name="viewport"
	...
	<div class="banner-top">
		<div class="container">
			<h2 class="animated wow fadeInLeft"
				data-wow-delay=".5s">Sản Phẩm</h2>
			<h3 class="animated wow fadeInRight"
             data-wow-delay=".5s"><a href="index.jsp">Trang Chủ</a><label>/</label>Sản Phẩm<label>/</label>Loại
			</h3>
	...
	<div class="product">
		<div class="container">
			<div class="col-md-3 product-bottom">
				...
				<div class="categories animated wow fadeInUp animated"
					...
					<ul class="cate">
                       ...
                       for (Brand b : brandget.getListBrand()) {
                                              %>
						<li><i class="glyphicon glyphicon-menu-right"></i><a
							   href="productbrand.jsp?brand=<%=b.getBrandID()%>"><%=b.getBrandName()%></a></li>
						<% } %>
					</ul>
				...
				<!--//price-->
				<!--colors-->
				<div class="colors animated wow fadeInLeft animated"
					 data-wow-delay=".5s">
					<h3>Màu Sắc</h3>
				...
				<!--//colors-->
				<div class="sellers animated wow fadeInUp"
					 data-wow-delay=".5s">
					...
					<div class="product-head">
						...
						<div class="product-go">
							<div class=" fashion-grid">
								<a href="single.jsp?productID=<%=p.getProductID()%>"><img class="img-responsive "
							...
							<div class=" fashion-grid1">
								...
								<p><a href="CartServlet?command=plus&productID=<%=p.getProductID()%>"
									   ...
									   class="but-hover1 item_add">Thêm vào giỏ</a></p>
							</div>
			...
			<div class="col-md-9 animated wow fadeInRight"
				 data-wow-delay=".5s">
					...
					<div class="col-sm-4 item-grid item-gr  simpleCart_shelfItem">
						...
						<div class="grid-pro">
							<div class=" grid-product ">
								<figure>
									<a href="single.jsp?productID=<%=p.getProductID()%>">
										<div class="grid-img">
											<img src="<%=p.getProductImageBack()%>"
												 class="img-responsive"
												 alt="">
										</div>
										<div class="grid-img">
											<img src="<%=p.getProductImageForward()%>"
												 class="img-responsive"
												 alt="">
										</div>
									</a>
							...
							<div class="women">
								<a href="#"><img src=""
										 alt=""></a>
								<h6><a href="single.jsp?productID=<%=p.getProductID()%>"><%=p.getProductName()%></a>
								</h6>
			...
			<div class="clearfix"> </div>
			<div class="social animated wow fadeInUp"
				 data-wow-delay=".1s">
				<div class="container">
