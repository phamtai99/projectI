...
public class BillGet {
    ...
    public void insertBill(Bill bill) throws SQLException, NamingException {
//        Connection connection = DBConnect.getConnecttion();
     ...
     public ArrayList<Bill> getListBill() throws NamingException {
        try {
             Context initContext = new InitialContext();
            DataSource ds = (DataSource) initContext.lookup("java:comp/env/jdbc/MusicShop");
     ...
     public ArrayList<Bill> getListBillByUser(long user_id) throws NamingException {
        try {
          Context initContext = new InitialContext();
            DataSource ds = (DataSource) initContext.lookup("java:comp/env/jdbc/MusicShop");
