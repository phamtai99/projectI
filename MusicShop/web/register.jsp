...
<script type="text/javascript">
	...
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.jsp">Trang Chủ</a><label>/</label>Đăng Ký</h3>
	...
	<fieldset disabled>
        <div class="form-group">
          <label for="disabledTextInput">Điều khoản tại website BK ACOUSTIC SHOP</label>
          <textarea type="text" id="disabledTextInput" class="form-control" placeholder="">* Mua hàng tại BKAS không được đổi trả. &#10;* Bạn hãy chắc địa chỉ bạn gửi là đúng. &#10;* Sau 3 ngày không chuyển khoản, đơn hàng sẽ xóa.&#10;* Phải biết rằng admin cute phô mai que </textarea>
          </fieldset>
