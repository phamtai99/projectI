            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <tr class="data">
                        ...
                        <td class="data"><img class="hinhql" src="/MusicShop/<%=product.getProductImageBack()%>"/></td>
                        <td class="data"> <img class="hinhql" src="/MusicShop/<%=product.getProductImageForward()%>"/></td>
