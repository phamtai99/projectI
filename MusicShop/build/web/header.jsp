                ...
                <div class="container">
                    <div class="header-left animated wow fadeInLeft" data-wow-delay=".5s">
                        <ul>
                            ...
                            <li><i class="glyphicon glyphicon-envelope" ></i><a href="mailto:@sis.hust.edu.vn">@sis.hust.edu.vn</a></li>
                    ...
                    <div class="header-right animated wow fadeInRight" data-wow-delay=".5s">
                        <div class="header-right1 ">
                            ...
                            <ul>
                                ...
                                <li><i class="glyphicon glyphicon-log-in" ></i><a href="admin/index.jsp">Admin</a></li>
                                        <% }%>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header nav_2">
                            ...
                            <div class="navbar-brand logo-nav-left ">
                                <h1 class="animated wow pulse" data-wow-delay=".5s"><a href="index.jsp">BK<span> ELECTRONIC SHOP</span></a></h1>
                            </div>
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="navigate.jsp">Account</a></li>
