...
<html>
    <head>
        ...
        <title>BK ACOUSTIC SHOP - THÔNG TIN SẢN PHẨM</title>
    ...
    <jsp:include page="header.jsp"></jsp:include>
        ...
        <div class="banner-top">
            <div class="container">
                ...
                <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.jsp">Trang Chủ</a><label>/</label>Sản Phẩm</h3>
                                ...
                                <h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-0"><span class="resp-arrow"></span>Mô Tả Sản Phẩm</h2><div class="tab-1 resp-tab-content resp-tab-content-active" aria-labelledby="tab_item-0" style="display:block">
                                    <div class="facts">
                                        ...
                                        <ul>
                                            ...
                                            <li>GIAO HÀNG MIỄN PHÍ VỚI HÓA SẢN TRÊN 2.000.000 Đ</li>
