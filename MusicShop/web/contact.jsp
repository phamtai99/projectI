...
<html>
    <head>
        ...
        <title>LIÊN HỆ CHÚNG TÔI - BK ACOUSTIC SHOP</title>
...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'>
	...
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.jsp">Trang Chủ</a><label>/</label>Liên Hệ</h3>
			...
			<div class="col-md-4 contact-grids">
				<div class=" contact-grid animated wow fadeInLeft" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Địa Chỉ</h4>
							1 Đại Cồ Việt, <span>Q.Hai Bà Trưng, Hà Nội.</span></p>
						</div>
					</div>
				</div>
				...
				<div class=" contact-grid animated wow fadeInRight" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Email</h4>
							<p><span><a href="contactto:info@example.com">@sis.hust.edu.vn</a></span></p>
						</div>
					</div>
				</div>
